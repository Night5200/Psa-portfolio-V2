...
```
    <div className="flex items-center gap-6 mt-5">
      <button onClick={prev} className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white">←</button>
      <span className="text-white/60 text-sm tabular-nums">
        {index + 1} / {campaign.images.length}
      </span>
      <button onClick={next} className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white">→</button>
    </div>
...
return ( <main className="w-full bg-black text-white"> <Navigation />
...
```
  ...
  {/* Video grids and campaign gallery remain exactly the same as your original */}
