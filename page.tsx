    ...
    <main className="w-full bg-black text-white">
      ...
      <section className="w-full bg-black px-6 md:px-16 py-24">
        <div className="max-w-2xl mx-auto">
          ...
          >
            Well you probably know that I&apos;m an AI artist — that&apos;s the reason why you&apos;re reading this. But that&apos;s not how it started. My journey began in Indore, where I worked as a <span className="text-white/90">Director of Photography</span> on ad films, short films, and UGC content. Being behind the camera taught me how much the little details matter — how light falls, how a frame is composed, and how those small choices can completely change the feeling of an image. But over time, I started to feel limited by the realities of physical shoots. No matter how hard you try, there are always constraints — locations, budgets, time, crew — and sometimes the vision in your head simply isn&apos;t possible to execute. Then I discovered AI-generated visuals, and everything changed. Suddenly I could create the kinds of images and scenes that would normally require huge productions. And that&apos;s what I bring to my work today — the eye of a DOP combined with the creative freedom of AI. When I create visuals, I&apos;m not just thinking about the image itself, but about the small details that make a frame feel alive and natural.
          </motion.p>
